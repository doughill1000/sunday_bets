// NFL team metadata — port of the web app's src/lib/types/domain.ts TEAM_META.
// Keyed by team short code (external_key); colors are [primary, secondary].
...
export function teamColor(short: string | null | undefined): string | null {
  if (!short) return null;
  return TEAM_META[short]?.colors[0] ?? null;
}
