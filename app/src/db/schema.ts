import { pgTable, uniqueIndex, foreignKey, pgPolicy, bigserial, uuid, text, bigint, numeric, timestamp, boolean, jsonb, integer, date, unique, primaryKey, pgView, pgEnum } from "drizzle-orm/pg-core"
...
export const gameLines = pgTable("game_lines", {
	...
	pgPolicy("sel_game_lines", { as: "permissive", for: "select", to: ["authenticated"] }),
]);
...
export const auditLog = pgTable("audit_log", {
	...
	pgPolicy("admin_sel_audit", { as: "permissive", for: "select", to: ["authenticated"] }),
...
export const settings = pgTable("settings", {
	...
	pgPolicy("admin_sel_settings", { as: "permissive", for: "select", to: ["authenticated"] }),
...
export const results = pgTable("results", {
	...
	pgPolicy("sel_results", { as: "permissive", for: "select", to: ["authenticated"] }),
]);
...
export const games = pgTable("games", {
	...
	pgPolicy("sel_games", { as: "permissive", for: "select", to: ["authenticated"] }),
]);
...
export const users = pgTable("users", {
	...
	pgPolicy("sel_users", { as: "permissive", for: "select", to: ["authenticated"] }),
...
export const totals = pgTable("totals", {
	...
	pgPolicy("sel_totals", { as: "permissive", for: "select", to: ["authenticated"] }),
]);
...
export const picks = pgTable("picks", {
	...
	pgPolicy("sel_picks_owner_or_started", { as: "permissive", for: "select", to: ["authenticated"] }),
