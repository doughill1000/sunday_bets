 ...
 * (#832) — played, graded, and 20h past kickoff, so `/picks` must show it nowhere and the
 * handoff strip must count it. Same order-independent matchup lookup as `resolveSeededGameId`.
 */
