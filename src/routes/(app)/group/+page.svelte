      ...
      <Card class="p-6">
        ...
        <CardContent class="space-y-4 p-0 pt-2">
          <p class="text-sm text-muted-foreground">
            Create invite links to share with new members.
          </p>
                  ...
                  <li class="flex items-center justify-between gap-2 rounded-lg border p-2 text-sm">
                    <div class="min-w-0">
                      ...
                      <p class="text-xs text-muted-foreground">
                        Used {invite.used_count}{invite.max_uses != null
                          ? `/${invite.max_uses}`
                          : ''} time{invite.used_count !== 1 ? 's' : ''}
                    ...
                    <div class="flex shrink-0 gap-1">
                      ...
                      <Button
                        ...
                        onclick={() => {
                          if (
                            confirm('Revoke this invite? Any existing links will stop working.')
                          ) {
