    ...
    <Card class="p-6">
      ...
      <CardContent class="space-y-4 p-0 pt-2">
        ...
        >
          ...
          <!-- No start-week control (ADR-0039): play starts the moment the league exists, and
               joining is the only participation boundary. -->
          <p class="text-xs text-muted-foreground">
            Play starts right away. Games that already kicked off don't count for anyone, and
            members who join later are scored from their join forward.
          </p>
